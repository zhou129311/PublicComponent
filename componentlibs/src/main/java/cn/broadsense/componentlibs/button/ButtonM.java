...
public class ButtonM extends Button{
    ...
    private String backColors = "#ff0000";//背景色，String类型，默认红色
    private int backColori = 0;//背景色，int类型
    private String backColorSelecteds = "#00ff00";//按下后的背景色，String类型，默认绿色
    ...
    private String textColorSeleteds = "#ffff00";//按下后的文字颜色，String类型
    private int textColorSeletedi = 0;//按下后的文字颜色，int类型
    private float radius = 30;//圆角半径
